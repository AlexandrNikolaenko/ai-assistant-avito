...
export default function RealEstateOptionalFields({
  ...
  return (
    <Flex vertical gap={8} style={{ width: "100%", alignItems: "start" }}>
      <Select
        status={
          (draft.params as RealEstateParams).type ? "validating" : "warning"
        }
        style={{
          width: "100%",
          maxWidth: "456px",
            ...
            prev
              ? {
                  ...
                  params: {
                    ...
                    type: value as "flat" | "house" | "room" | undefined,
      ...
      <Input
        status={
          String((draft.params as RealEstateParams).address ?? "") == ""
            ? "warning"
            : "validating"
        }
        style={{ width: "100%", maxWidth: "456px" }}
        placeholder="Адрес"
        value={String((draft.params as RealEstateParams).address ?? "")}
        onChange={(e) => setParamString("address", e.target.value)}
      />
      <Input
        status={
