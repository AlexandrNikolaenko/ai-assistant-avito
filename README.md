...
Страницу редактирования объявления было решено оставить в виде одной формы, вынеся в виджеты только опциональные характеристики в виду ограниченности по времени и сложной взаимосвязонности логики изменения состояний компонентов.
